...
public class LogAggregator {
     ...
     * @param numSeconds
     */
    public void processKafka(final String group, final String[] topics,
                             final String zookeeper, final int numThreads, final int numSeconds) {
        ...
        // Create stream for ImpressionLogs
        JavaPairDStream<String, ImpressionLog> messages = KafkaUtils.createStream(jssc, String.class,
                ImpressionLog.class, StringDecoder.class, ImpressionLogDecoder.class,
        ...
        LOG.info("Perform Aggregation of data");
        // Perform Aggregation by Key and Window size that is 2 times the batch time.
        // So if batch time is 1 sec, aggregation is performed every 2 secs.
        ...
        JavaPairDStream<PublisherGeoKey, AggregationLog> aggLogs = logsByPubGeo.reduceByKeyAndWindow(
                new ReduceAggregationLogs(), Durations.seconds(numSeconds * 2), Durations.seconds(numSeconds * 2));
