...
class DataFrameRowIterator implements Iterable<LocatedRow>{
    
    /**
     * Log object to log messages.  The log messages in this class will appear
     * in the HBASE Region Server logs
     */    
    private static final Logger LOG = Logger.getLogger(DataFrameRowIterator.class);
    ...
    public DataFrameRowIterator(java.util.List<Row> pRows, ArrayList<String> pSourceColumns, ExecRow pExecRow) {
        LOG.info("Begin - Creating DataFrameRowIterator with list of rows");
