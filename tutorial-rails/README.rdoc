...
* System dependencies
  The client jar file needs to be placed in the classpath mentioned below:
  The db-client-2.x.x.x.jar needs to be placed in the lib folder of the jruby
  In my case it was at /Users/amitmudgal/.rbenv/versions/jruby-9.1.5.0/lib
  Remember to install the jdbcderby-adapter using the command "gem install activerecord-jdbcderby-adapter"
